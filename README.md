Neste projeto, foi criada a classe Moto, representando um objeto do mundo real. A classe possui os atributos modelo, cor, nacionalidade e ano de fabricação.

Também foram implementados os métodos get e set, responsáveis por obter e definir os valores desses atributos, seguindo o princípio do encapsulamento.
